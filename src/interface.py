...
class Interface:
    ...
    def __init__(self, parent) -> None:
        ...
        grade_btn = tk.Button(self.root, text="start grading",
                              command=self.grade_window, pady=10)

        new_question = tk.Label(
    ...
    def grade_window(self):
        ...
        submit_grade_btn = tk.Button(
            new_window, text="Save answer", command=store_grade, default="disabled")

...
class StatusInterface:
    ...
    def elements(self):
        exit_btn = tk.Button(self.root, text="Return to main screen", command=self.parent.kill_status_gui).pack()
        ...
        for question in questions:
            ...
            archive_btn = tk.Button(self.root, text="Archive this question", command= lambda: self.archiver(question[0])).pack()
